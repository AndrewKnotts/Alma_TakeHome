...
export default function LeadDetail() {
  ...
  if (err)
    return (
      <div className="card" style={{ maxWidth: 740, margin: "0 auto", color: "#b00020" }}>
        {err}
      </div>
    );
  if (!lead)
  ...
  return (
    <div className="card" style={{ maxWidth: 740, margin: "2rem auto" }}>
      ...
      <div style={{ marginTop: 12 }}>
        ...
        <div>
          {lead.resume ? (
            <a download={lead.resume.filename} href={`data:${lead.resume.mime};base64,${lead.resume.base64}`}>
              Download
            </a>
          ) : (
            "—"
